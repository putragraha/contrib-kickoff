...
public abstract class Hilt_SearchRepoFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SearchRepoFragment() {
    super();
  }

  Hilt_SearchRepoFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SearchRepoFragment_GeneratedInjector) this.generatedComponent()).injectSearchRepoFragment(UnsafeCasts.<SearchRepoFragment>unsafeCast(this));
    }
  }
